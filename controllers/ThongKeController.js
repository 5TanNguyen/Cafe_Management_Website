...
class ThongKeController {
  ...
  static async getThongKeTheoNgay(req, res) {
...

    {
      ...
      var dd = await ThongKeModel.GetThongKeTheoNgayDonDat(
        date_begin,
        date_end
      );

      var dn = await ThongKeModel.GetThongKeTheoNgayDonNhap(
        date_begin,
        date_end
      );

      var cc = await ThongKeModel.GetThongKeTheoNgayNhanVien(
        date_begin,
        date_end
      );
      ...
      if (result != null) {
        res.render("thongke/thongketheongay", {
          test: result,
          dn,
          dd,
          cc,
