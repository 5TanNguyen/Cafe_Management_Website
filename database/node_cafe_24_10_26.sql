CREATE DATABASE  IF NOT EXISTS `node_cafe` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `node_cafe`;
...
CREATE TABLE `customers` (
  ...
  PRIMARY KEY (`id`),
  KEY `customers_customer_type_id_foreign_idx` (`customer_type_id`),
  CONSTRAINT `customers_customer_type_id_foreign_idx` FOREIGN KEY (`customer_type_id`) REFERENCES `customertypes` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `permissions` VALUES (1,'thongke','Thống kê','2024-10-26 16:42:51','2024-10-26 16:42:48'),(2,'phache','Pha chế','2024-10-26 16:42:59','2024-10-26 16:43:02');
...
INSERT INTO `sequelizemeta` VALUES ('create-allcode.js'),('create-booking.js'),('create-clinic.js'),('create-customer-24_10_26_ c.js'),('create-customer-24_10_26_ cee.js'),('create-customer-24_10_26_ co.js'),('create-customer-24_10_26_ cop.js'),('create-customer-24_10_26_ copy.js'),('create-customer-24_10_26_.js'),('create-customer-type.js'),('create-doctor-clinic-specialty.js'),('create-history.js'),('create-permission.js'),('create-post.js'),('create-role.js'),('create-schedule.js'),('create-specialty.js'),('create-user-24_10_26.js'),('create-user-24-10-26--.js'),('create-user-24-10-26-.js'),('create-user-24-10-26.js'),('customer-customer-type_.js'),('customer-customer-type.js'),('role-permission.js');
...
INSERT INTO `users` VALUES (1,'5tannguyenhuu@gmail.com','12345','Tấn','Nguyễn','Cần Thơ','0328069555',1,'5tan.png',1,'2024-10-26 16:03:21','2024-10-26 16:03:24',1);
...
-- Dump completed on 2024-10-26 16:50:42
