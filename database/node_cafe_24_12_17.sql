...
--
-- Host: localhost    Database: node_cafe
-- ------------------------------------------------------
...
INSERT INTO `costs_incurred` VALUES (1,'Tiền dọn rác',50000,NULL,10,1),(2,'Tiền điện',200000,NULL,11,2),(3,'Phí X',20000,NULL,11,1),(4,'Tiền giấy in',25000,NULL,16,2),(5,'Phí vệ sinh',50000,NULL,16,1),(6,'Phí Y',25000,NULL,16,2),(7,'Phí A',100000,NULL,16,1);
...
INSERT INTO `orders` VALUES (279,NULL,1,2,1,1,0,0,145000,'2023-03-21 16:00:56',4,0),(280,NULL,1,1,1,1,1,1,145000,'2023-03-26 12:20:50',9,0),(281,NULL,1,3,2,0,1,1,54000,'2023-03-26 22:22:07',9,0),(283,NULL,1,2,1,1,1,1,100000,'2023-03-27 12:13:32',10,0),(284,NULL,1,10,4,1,0,0,0,'2023-03-27 14:53:04',10,0),(285,NULL,1,3,3,1,1,1,99000,'2023-03-28 10:46:06',11,0),(286,NULL,1,2,2,1,1,1,30000,'2023-03-28 14:20:24',11,0),(287,NULL,1,1,1,1,1,1,145000,'2023-03-31 22:48:40',12,0),(288,NULL,1,2,1,1,1,1,29000,'2023-04-02 22:39:18',13,0),(289,NULL,1,1,2,1,1,1,40000,'2023-04-03 20:36:07',15,0),(290,NULL,1,2,2,1,1,1,54000,'2023-04-03 20:46:07',15,0),(291,NULL,1,6,6,1,1,1,125000,'2023-04-04 08:20:34',16,0),(292,NULL,1,7,2,1,1,1,56000,'2023-04-04 09:04:59',16,0),(293,NULL,1,4,1,1,1,1,20000,'2023-04-04 09:05:39',16,0),(294,NULL,1,6,1,1,1,1,29000,'2023-04-04 09:07:18',16,0),(295,NULL,1,3,1,1,1,1,58000,'2023-04-04 10:00:18',16,0),(296,NULL,1,2,1,1,1,1,86000,'2023-04-04 10:18:08',16,0),(297,NULL,1,1,1,1,1,1,30000,'2023-04-04 13:42:54',16,0),(298,NULL,1,5,5,1,1,1,140000,'2023-04-04 13:44:33',16,0),(299,NULL,1,4,1,1,1,1,30000,'2023-04-04 13:59:53',16,0),(300,NULL,1,6,1,1,1,1,20000,'2023-04-04 14:05:00',16,0),(301,NULL,1,1,1,1,1,1,30000,'2023-04-04 15:03:41',16,0),(302,NULL,1,1,1,1,1,1,29000,'2023-04-04 15:10:14',16,0);
...
INSERT INTO `permissions` VALUES (1,'bx bx-bar-chart-alt-2','thongke','getThongKe','Quản lý thống kê','2024-10-26 16:42:51','2024-10-26 16:42:48'),(2,'bx bx-receipt','donnhap','getDonNhap','Quản lý đơn nhập','2024-10-26 16:42:59','2024-10-26 16:43:02'),(3,'bx bx-user','nhanvien','getAllNhanVien','Quản lý nhân viên','2024-10-28 15:34:23','2024-10-28 15:34:25'),(4,'bx bxs-coffee-bean','nguyenlieu','getNguyenLieu','Quản lý nguyên liệu','2024-11-06 16:13:57','2024-11-06 16:14:00');
...
CREATE TABLE `role_permissions` (
  ...
  CONSTRAINT `role_permissions_ibfk_9` FOREIGN KEY (`permission_id`) REFERENCES `permissions` (`id`) ON UPDATE CASCADE
...
INSERT INTO `role_permissions` VALUES (1,1,1,'2024-10-28 16:11:20','2024-10-28 16:11:20'),(2,1,2,'2024-10-28 16:11:23','2024-10-28 16:11:23'),(3,1,3,'2024-10-28 16:33:26','2024-10-28 16:33:28');
...
INSERT INTO `roles` VALUES (1,'super-admin','Super Admin','2024-10-26 16:03:45','2024-10-26 16:03:48'),(2,'admin','Admin','2024-10-26 16:41:32','2024-10-26 16:41:34'),(3,'bartender','Pha chế','2024-11-06 16:09:14','2024-11-06 16:09:16'),(4,'waiter','Phục vụ','2024-11-06 16:09:30','2024-11-06 16:09:33');
...
INSERT INTO `sequelizemeta` VALUES ('create-allcode.js'),('create-booking.js'),('create-clinic.js'),('create-customer-24_10_26_ c.js'),('create-customer-24_10_26_ cee.js'),('create-customer-24_10_26_ co.js'),('create-customer-24_10_26_ cop.js'),('create-customer-24_10_26_ copy.js'),('create-customer-24_10_26_.js'),('create-customer-type.js'),('create-doctor-clinic-specialty.js'),('create-history.js'),('create-permission.js'),('create-post.js'),('create-role-permission.js'),('create-role.js'),('create-schedule.js'),('create-specialty.js'),('create-user-24_10_26.js'),('create-user-24-10-26--.js'),('create-user-24-10-26-.js'),('create-user-role.js'),('create-user.js'),('customer-customer-type_.js'),('customer-permission-add-column.js');
...
INSERT INTO `timekeeping` VALUES (27,NULL,2,'2023-03-21 15:59:26','',4,NULL,0),(28,NULL,2,'2023-03-26 12:20:07','',9,NULL,0),(29,NULL,2,'2023-03-27 12:01:10','',9,NULL,0),(30,NULL,3,'2023-03-27 18:51:33',NULL,10,NULL,0),(31,NULL,1,'2023-03-28 10:45:58','',11,NULL,0),(34,NULL,3,'2023-03-31 22:49:18','',12,NULL,0),(36,NULL,3,'2023-04-02 22:37:15','',13,NULL,0),(37,NULL,3,'2023-04-02 22:38:00','',13,NULL,0),(38,NULL,3,'2023-04-03 20:35:24','',13,NULL,0),(39,NULL,3,'2023-04-03 20:35:51','',15,NULL,0),(40,NULL,1,'2023-04-04 08:20:06','',16,NULL,0),(41,NULL,2,'2023-04-04 13:26:08','',16,NULL,0),(42,NULL,2,'2023-04-04 13:55:06','',16,NULL,0),(43,NULL,2,'2023-04-04 13:53:40','',16,NULL,0);
...
CREATE TABLE `user_roles` (
  ...
  KEY `user_id` (`user_id`),
  KEY `role_id` (`role_id`),
  CONSTRAINT `user_roles_ibfk_8` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`) ON UPDATE CASCADE,
...
INSERT INTO `user_roles` VALUES (1,1,1,'2024-10-28 16:11:13','2024-10-28 16:11:13'),(2,2,3,'2024-11-06 16:10:39','2024-11-06 16:10:42');
...
INSERT INTO `users` VALUES (1,'5tannguyenhuu@gmail.com','5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5','Tấn','Nguyễn','Cần Thơ','0328069555',1,'5tan.jpg',1,'2024-10-28 15:33:12','2024-10-28 15:33:16'),(2,'9thoanguyenthikim@gmail.com','1234','Thoa','Nguyễn','Cần Thơ','0354136300',0,'yae2.jpg',1,'2024-11-06 16:08:14','2024-11-06 16:08:17');
...
-- Dump completed on 2024-12-17 13:51:27
