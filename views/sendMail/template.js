...
const link_contact = "facebook.com"

const htmlContent = (firstName) =>{
  return `
        ...
        <tr style="width:100%">
          <td>
                  ...
                  <td>
                    <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation">
                      <tbody style="width:100%">
                        <tr style="width:100%"><img src="https://react-email-demo-48zvx380u-resend.vercel.app/static/yelp-header.png" style="display:block;outline:none;border:none;text-decoration:none;max-width:100%" width="620" /></tr>
                      </tbody>
                    </table>
                      ...
                      <tbody style="width:100%">
                        <tr style="width:100%">
                          <td data-id="__react-email-column">
                            ...
                            <h2 style="font-size:26px;font-weight:bold;text-align:center">Thank you for your concern about our shop</h2>
                            <p style="font-size:16px;line-height:24px;margin:16px 0"><b>Time: </b>${month} ${date}, ${year} at ${currTime}</p>
            ...
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="padding:45px 0 0 0">
              <tbody>
                <tr>
                  <td><img src="https://react-email-demo-48zvx380u-resend.vercel.app/static/yelp-footer.png" style="display:block;outline:none;border:none;text-decoration:none;max-width:100%" width="620" /></td>
                </tr>
              </tbody>
            </table>    
          </td>
